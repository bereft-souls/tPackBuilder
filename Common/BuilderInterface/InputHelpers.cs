...
internal static class InputHelpers
{
    ...
    )
    {
        ...
        // TODO: Priority for backspace/del
                 ...
                 backspaceTimer <= 0))
            {
                if (CursorPositon >= 1)
                {
                    output = string.Concat(
                        output.AsSpan(0, CursorPositon - 1),
                ...
                attemptedBackspace = CursorPositon < 0;
            }
        }
        ...
        // Delete
        {
            ...
            if (Keys.Delete.JustPressed ||
                (Keys.Delete.Held &&
                 backspaceTimer <= 0))
            {
                if (CursorPositon < output.Length)
                {
                    output = string.Concat(
